...
# see warehouse_sql.EPISODE_FILE_JOIN for why, and for why it is an OR of
# equalities rather than the CASE that reads more directly.
_EPISODE_FILE_JOIN = EPISODE_FILE_JOIN
